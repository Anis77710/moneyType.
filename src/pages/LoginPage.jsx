      ...
      <main className="flex-grow flex items-center justify-center px-4 pt-32 pb-16">
        ...
        <div className="w-full max-w-[420px]">
          <div className="text-center mb-10">
            <h1 className="font-display-lg text-[40px] text-primary mb-3">Welcome back</h1>
            <p className="font-body-md text-body-md text-secondary opacity-60">Sign in to continue your typing journey</p>
          </div>

          {resetSent && (
            <div className="mb-6 p-4 rounded-lg border border-primary/30 bg-primary/5 flex items-start gap-3 animate-fadeIn">
              <span className="material-symbols-outlined text-primary mt-0.5">mark_email_read</span>
              <div>
                <p className="font-label-sm text-label-sm text-primary font-bold mb-1">Check your inbox</p>
                <p className="font-label-sm text-label-sm text-secondary opacity-60">Password reset link sent to {email}</p>
              </div>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-5">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer group">
                <input
                  ...
                  className="w-4 h-4 rounded border-outline-variant bg-surface-container text-primary focus:ring-primary/30 focus:ring-offset-0 cursor-pointer accent-[#ffd341]"
                />
                <span className="font-label-sm text-label-sm text-secondary opacity-60 group-hover:opacity-100 transition-opacity">Remember me</span>
              </label>
              <button
                type="button"
            ...
            >
              {submitting ? (
                <><span className="w-4 h-4 border-2 border-background border-t-transparent rounded-full animate-spin"></span> Signing in...</>
              ) : 'Sign In'}
            </button>
